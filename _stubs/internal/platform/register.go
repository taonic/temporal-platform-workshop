...
// the next two challenges it is the only file you edit. Everything it names is
// already written: the workflows in internal/platform/workflow, the activities in
// internal/platform/activity. None of it runs, because a worker only knows what it
// has been told about.
//
...
//
// Uncomment one block per challenge, and read what you turned on before you
// turn it on.
func Register(w worker.Worker, a *activity.Activities) {
	...
	// second lesson in it -- and it keeps this file compiling while everything
	// below is still commented out.
