...
// `pnpm snippets:emit` writes it back to internal/platform/register.go and
// `./scripts/workshop verify` compiles it there, so a drifted copy fails CI rather
// than a student's paste.
export const REGISTER_GO = `package platform
