...
// The ConfigMap is not decoration. Delivering a generated config as a ConfigMap
// is the shape a production operator uses, and mounting it here means the worker's
// declared queues are inspectable with kubectl rather than baked opaquely into an
// image.
